...
public class gunner1_2 : MonoBehaviour {
	...
	void Update () {
		...
		theFsm.FsmVariables.GetFsmFloat ("IntEvilHomeHP1_2").Value = EVILCASTLE1_2.HP;

		theFsm.FsmVariables.GetFsmFloat ("IntHomeHP1_2").Value = castle1_2.castleHP1_2;
	}
