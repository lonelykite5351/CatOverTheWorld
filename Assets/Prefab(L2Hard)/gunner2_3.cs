...
public class gunner2_3 : MonoBehaviour {
	...
	void Update () {
		...
		theFsm.FsmVariables.GetFsmFloat ("IntEvilHomeHP2_3").Value = EVILCASTLE2_3.HP;

		theFsm.FsmVariables.GetFsmFloat ("IntHomeHP2_3").Value = castle2_3.castleHP2_3;
	}
