...
public class gunner4_2 : MonoBehaviour {
	...
	void Update () {
		...
		theFsm.FsmVariables.GetFsmFloat ("IntEvilHomeHP4_2").Value = EVILCASTLE4_2.HP;

		theFsm.FsmVariables.GetFsmFloat ("IntHomeHP4_2").Value = castle4_2.castleHP4_2;
	}
