...
public class gunner2_1 : MonoBehaviour {
	...
	void Update () {
		...
		theFsm.FsmVariables.GetFsmFloat ("IntEvilHomeHP2_1").Value = EVILCASTLE2_1.HP;

		theFsm.FsmVariables.GetFsmFloat ("IntHomeHP2_1").Value = castle2_1.castleHP2_1;
	}
