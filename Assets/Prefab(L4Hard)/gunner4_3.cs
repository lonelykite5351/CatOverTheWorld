...
public class gunner4_3 : MonoBehaviour {
	...
	void Update () {
		...
		theFsm.FsmVariables.GetFsmFloat ("IntEvilHomeHP4_3").Value = EVILCASTLE4_3.HP;

		theFsm.FsmVariables.GetFsmFloat ("IntHomeHP4_3").Value = castle4_3.castleHP4_3;
	}
