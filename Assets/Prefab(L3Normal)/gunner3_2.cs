...
public class gunner3_2 : MonoBehaviour {
	...
	void Update () {
		...
		theFsm.FsmVariables.GetFsmFloat ("IntEvilHomeHP3_2").Value = EVILCASTLE3_2.HP;

		theFsm.FsmVariables.GetFsmFloat ("IntHomeHP3_2").Value = castle3_2.castleHP3_2;
	}
