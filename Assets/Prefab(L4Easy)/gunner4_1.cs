...
public class gunner4_1 : MonoBehaviour {
	...
	void Update () {
		...
		theFsm.FsmVariables.GetFsmFloat ("IntEvilHomeHP4_1").Value = EVILCASTLE4_1.HP;

		theFsm.FsmVariables.GetFsmFloat ("IntHomeHP4_1").Value = castle4_1.castleHP4_1;
	}
