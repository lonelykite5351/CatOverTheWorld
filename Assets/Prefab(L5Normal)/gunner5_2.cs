...
public class gunner5_2 : MonoBehaviour {
	...
	void Update () {
		...
		theFsm.FsmVariables.GetFsmFloat ("IntEvilHomeHP5_2").Value = EVILCASTLE5_2.HP;

		theFsm.FsmVariables.GetFsmFloat ("IntHomeHP5_2").Value = castle5_2.castleHP5_2;
	}
